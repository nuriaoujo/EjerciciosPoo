...
public Menu(){
    ...
    Food bistec = new Food("Bistec",0,15,27);
    Food lechuga = new Food("Lechuga",1,0,0);
    Food quesoFresco = new Food("Queso fresco",1,23,24);
    Food huevo = new Food("Huevo",0,11,13);
    Food boqueron = new Food("Boquerón",1,2,16);
    Food salmon = new Food("Salmón",0,12,18);
    Food trufa = new Food("Trufa",0,0,6);
    Food lenteja = new Food("Lenteja",54,2,25);

    arrayFoods.add(zanahoria);
    arrayFoods.add(bistec);
    arrayFoods.add(lechuga);
    arrayFoods.add(quesoFresco);
    arrayFoods.add(huevo);
    arrayFoods.add(boqueron);
    arrayFoods.add(salmon);
    arrayFoods.add(trufa);
    arrayFoods.add(lenteja);
}
        ...
        if (diet != null) {
            ...
            switch (dietType) {
                ...
                case 3:
                    ...
                    diet.macronutrientesDiet(diet.isWomen(), diet.getAge(), diet.getHeight(), diet.getWeight());
                    break;
    ...
    public void addFood(Food food) {
        if(diet != null) {
            switch (diet.getDietType()) {
                ...
                case 2: //Por calorías
                    diet.caloriesDiet(food);
                    break;

                case 3: //por macronutrientes NO FUNCIONA BIEN
                    diet.macroDiet(food);
                    break;
                case 4: //Datos personales
                    diet.personalDiet(food);
                    break;
